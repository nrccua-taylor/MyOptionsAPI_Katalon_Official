...
RequestObject getUserInfoTestObject = findTestObject('Helpers/Mentors/Get_MentorMentee', [('G_ENVIRONMENT_URL') : GlobalVariable.G_ENVIRONMENT_URL
            , ('G_studentID_TS') : GlobalVariable.G_studentID_TS, ('G_TimeStampMentorEmailAddress') : GlobalVariable.G_TimeStampMentorEmailAddress])
