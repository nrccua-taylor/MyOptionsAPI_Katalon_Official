...
WS.sendRequestAndVerify(findTestObject('Helpers/UserMgmt/ChangePassword_MissingPassword', [('G_API_URL_changePassword') : GlobalVariable.G_API_URL_CHANGEPASSWORD
