...
WS.sendRequestAndVerify(findTestObject('Helpers/UserMgmt/ChangePassword_MissingLastName', [('G_API_URL_changePassword') : GlobalVariable.G_API_URL_CHANGEPASSWORD
